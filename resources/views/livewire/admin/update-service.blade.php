    ...
    <div class="card card-primary col-8 mr-auto ml-auto">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="switch-field">
                        @if($service->status == 0)
                            <input type="radio" id="radio-one" name="switch-one" wire:model="status" value="1"/>
                            <label for="radio-one">On</label>
                            <input type="radio" id="radio-two" name="switch-one" wire:model="status" value="0" checked/>
                ...
                <div class="col-6 custom-file">
                    <div class="row">
                        @if(empty($new_image))
                            <div class="col-6">
                                <input type="file" class="custom-file-input" id="customFile" wire:model="new_image">
                            ...
                            <div class="col-6 ">
                                <img src="{{asset('images/services')}}/{{$service->image}}" width="150" height="100"
                                     alt="{{$service->name}}">
                            </div>
                        @else
                            <div class="col-6">
                            ...
                            <div class="col-6 ">
                                <img src="{{$new_image->temporaryUrl()}}" width="150" height="100"
                                     alt="{{$service->name}}">
            ...
            <div>
                ...
                <button type="submit" class="btn btn-info" wire:click.prevent="UpdateService">Update</button>
            </div>
